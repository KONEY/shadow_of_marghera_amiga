...
FLAME_FRMS:	DC.L FLAME_MASK,FLAME_MASK+$2
		...
		DC.L FLAME_MASK+(flameHe*8*2),FLAME_MASK+(flameHe*8*2)+$2
		DC.L FLAME_MASK+$2
		DC.L FLAME_MASK+(flameHe*10*2),FLAME_MASK+(flameHe*10*2)+$2
		DC.L FLAME_MASK+(flameHe*12*2),FLAME_MASK

		DC.L FLAME_MASK+(flameHe*6*2)
		DC.L FLAME_MASK+(flameHe*12*2)
		DC.L FLAME_MASK+$2,FLAME_MASK+(flameHe*8*2)

		DC.L FLAME_MASK+$2,FLAME_MASK+(flameHe*4*2),FLAME_MASK
		DC.L FLAME_MASK+(flameHe*10*2)+$2
		DC.L FLAME_MASK+(flameHe*2*2)+$2

		DC.L FLAME_MASK+(flameHe*10*2)+$2,FLAME_MASK+(flameHe*10*2)
		DC.L FLAME_MASK+(flameHe*8*2)+$2,FLAME_MASK+(flameHe*8*2),FLAME_MASK+(flameHe*6*2)+$2
		DC.L FLAME_MASK+$2,FLAME_MASK+(flameHe*4*2)+$2
		DC.L FLAME_MASK+(flameHe*6*2)+$2,FLAME_MASK+(flameHe*6*2)
		DC.L FLAME_MASK+(flameHe*4*2)+$2,FLAME_MASK+(flameHe*4*2)
		DC.L FLAME_MASK+(flameHe*2*2)+$2,FLAME_MASK+(flameHe*2*2)
		DC.L FLAME_MASK+(flameHe*12*2),FLAME_MASK+$2
		DC.L FLAME_MASK+$2,FLAME_MASK

		DC.L FLAME_MASK+(flameHe*4*2)+$2,FLAME_MASK+(flameHe*4*2)
		DC.L FLAME_MASK+(flameHe*8*2),FLAME_MASK+(flameHe*8*2)+$2
		DC.L FLAME_MASK+(flameHe*10*2)+$2,FLAME_MASK+(flameHe*10*2)
		DC.L FLAME_MASK+(flameHe*12*2),FLAME_MASK,0

FLAME_FRMS_IDX:	DC.W 0
FIRE_NEXT_ADDR:	DC.L SPRFIRE1-622
PF1_SCR_IDX:	DC.W 0
PF1_SCREENS:	DC.L PF1S1,PF1S4,PF1S2,PF1S3,PF1S4,PF1S5,PF1S6,PF1S7,PF1S8,PF1S1,PF1S9,PF1S3,0
PF2_SCR_IDX:	DC.W 0
PF2_SCREENS:	DC.L PF2S1,PF2S2,PF2S3,PF2S4,PF2S5,PF2S6,PF2S7,PF2S1
		DC.L PF2S8,PF2S9,PF2SA,PF2SB,PF2SE,PF2SC,PF2SD,PF2SF,PF2SD,PF2SE,0
SCROLL_IDX:	DC.W 0
...
FLAME_MASK:	INCBIN "flame_mask_032x266x1.raw"
...
PF2SF:	INCBIN "PF2-F_320x116x3.raw"
