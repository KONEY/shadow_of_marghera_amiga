...
__SPILL_FIRE1:
	...
	MOVE.W	#$0,BLTDMOD(A6)
	MOVE.W	#%0000000010000000,BLTAFWM(A6)
	MOVE.W	#%0000000010000000,BLTALWM(A6)
	MOVE.W	#($4<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000000010000000,BLTAFWM(A6)
	MOVE.W	#%0000000011000000,BLTALWM(A6)
	MOVE.W	#($B<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000000111000000,BLTAFWM(A6)
	MOVE.W	#%0000000011000000,BLTALWM(A6)
	MOVE.W	#($4<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000000111100000,BLTAFWM(A6)
	MOVE.W	#%0000001111100000,BLTALWM(A6)
	;MOVE.W	(A5)+,BLTAMOD(A6)
	MOVE.W	#($1<<6)+32/16,BLTSIZE(A6)
	MOVE.W	#%0000001111100000,BLTAFWM(A6)
	MOVE.W	#%0000011111000000,BLTALWM(A6)
	;MOVE.W	(A5)+,BLTAMOD(A6)
	MOVE.W	#($C<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000000111000000,BLTAFWM(A6)
	MOVE.W	#%0000000111100000,BLTALWM(A6)
	MOVE.W	#($4<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000000011000000,BLTAFWM(A6)
	MOVE.W	#%0000000001100000,BLTALWM(A6)
...
__SPILL_FIRE2:
	...
	;MOVE.W	(A5),BLTAMOD(A6)
	MOVE.W	#$0,BLTDMOD(A6)
	MOVE.W	#%0000000100000000,BLTAFWM(A6)
	MOVE.W	#%0000001000000000,BLTALWM(A6)
	MOVE.W	#($5<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%000001100000000,BLTAFWM(A6)
	MOVE.W	#%0000011000000000,BLTALWM(A6)
	MOVE.W	#($C<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000001110000000,BLTAFWM(A6)
	MOVE.W	#%0000001100000000,BLTALWM(A6)
	MOVE.W	#($3<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000011111000000,BLTAFWM(A6)
	MOVE.W	#%0000011100000000,BLTALWM(A6)
	;MOVE.W	(A5)+,BLTAMOD(A6)
	MOVE.W	#($2<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000011111100000,BLTAFWM(A6)
	MOVE.W	#%0000011111000000,BLTALWM(A6)
	;MOVE.W	(A5)+,BLTAMOD(A6)
	MOVE.W	#($9<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000001111000000,BLTAFWM(A6)
	MOVE.W	#%0000001110000000,BLTALWM(A6)
	MOVE.W	#($5<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.W	#%0000000110000000,BLTAFWM(A6)
	MOVE.W	#%0000000011000000,BLTALWM(A6)
	MOVE.W	#($3<<6)+32/16,BLTSIZE(A6)
	RTS
...
SPRFIRE1:	DC.B $41,$B4,$41+$27,%00000000	; VSTART $2C-$F2 | HSTART $44 | VSTOP | CTRLBITS
	.data:
	DC.W $E00E,$E00E
	DC.W $E00E,$E00E
	DC.W $E00E,$E00E
	...
	DC.W $FFFF,$F0F0
	DC.L 0
SPRFIRE2:	DC.B $41,$B5,$41+$27,%10000001	; VSTART $2C-$F2 | HSTART $44 | VSTOP | CTRLBITS
	.data:
	DC.W $E00E,$E00E
	DC.W $E00E,$E00E
	DC.W $E00E,$E00E
