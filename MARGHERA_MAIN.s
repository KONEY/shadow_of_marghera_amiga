...
__SPILL_FIRE:
	...
	LEA	PF2S1+(bypl*100),A3		; SRC
	LEA	SPRFIRE\.data,A4		; DEST
	BSR	WaitBlitter
	MOVE.L	#(((0<<12)+%100111110000)<<16)+%00,BLTCON0(A6)
	MOVE.L	#$01800180,BLTAFWM(A6)
	MOVE.W	(A5)+,BLTAMOD(A6)
	MOVE.W	#$0,BLTDMOD(A6)
	MOVE.L	A3,BLTAPTH(A6)
	MOVE.L	A4,BLTDPTH(A6)
	MOVE.W	#($E<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.L	#$034002C0,BLTAFWM(A6)
	MOVE.W	(A5)+,BLTAMOD(A6)
	MOVE.W	#($10<<6)+32/16,BLTSIZE(A6)
	BSR	WaitBlitter
	MOVE.L	#$018000C0,BLTAFWM(A6)
	MOVE.W	(A5),BLTAMOD(A6)
...
SPRFIRE_:	DC.B $42,$B5,$42+$27,%10000000	; VSTART $2C-$F2 | HSTART $44 | VSTOP | CTRLBITS
SPRFIRE:	DC.B $42,$B5,$42+$27,%00000000	; VSTART $2C-$F2 | HSTART $44 | VSTOP | CTRLBITS
	.data:
	DC.W $E00E,$E00E
	DC.W $E00E,$E00E
	DC.W $E00E,$E00E
...
COPPER:	; #### COPPERLIST ####################################################
	...
	DC.W BPLCON2,%01000000 ; SCROLL REGISTER (AND PLAYFIELD PRI)
	.PFsScrolling:
	DC.W BPLCON1,$88
	...
	DC.W $01A0,$0F00,$01A0,$0FF0,$01A4,$0800,$01A6,$0880
	DC.W $01A8,$0D58,$01AA,$0550,$01AC,$0310,$01AE,$0F82
	DC.W $01B0,$0551,$01B2,$0F40,$01B4,$0CD2,$01B6,$0900
	DC.W $01B8,$0D00,$01BA,$0410,$01BC,$0C00,$01BE,$0AB0
	;.RedLight:
	;DC.W $01A6,$0F00
