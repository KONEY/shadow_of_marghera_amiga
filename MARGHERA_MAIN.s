...
FRM_COUNT:	DC.W 0
FLAME_FRMS:	DC.L FLAME_MASK,FLAME_MASK+$26*4,0
FLAME_FRMS_IDX:	DC.W 0
FIRE_NEXT_ADDR:	DC.L _MED_MODULE-40*2048
PF1_SCREENS:	DC.L PF1S1,PF1S2,PF1S3,PF1S4,PF1S5,PF1S6,PF1S1,0
PF1_SCR_IDX:	DC.W 0
...
FLAME_MASK:	INCBIN "flame_mask_32x76x1.raw"
SPRFIRE1:	DC.B $41,$B4,$41+$27,%00000001	; VSTART $2C-$F2 | HSTART $44 | VSTOP | CTRLBITS
	.data:
	DCB.W $26*2,0
	DC.L 0
SPRFIRE2:	DC.B $41,$B4,$41+$27,%10000001	; VSTART $2C-$F2 | HSTART $44 | VSTOP | CTRLBITS
	.data:
	DCB.W $26*2,0
	DC.L 0
...
COPPER:	; #### COPPERLIST ####################################################
	...
	DC.W $01A0,$0EF2,$01A2,$0ED2,$01A4,$0EA2,$01A6,$0D91
